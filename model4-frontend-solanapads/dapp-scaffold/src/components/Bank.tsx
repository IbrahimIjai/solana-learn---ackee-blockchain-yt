...
export const Bank: FC = () => {
	...
	return (
		<div>
			{banks.map((bank) => {
				return (
					<div className="flex flex-col md:hero-content" key={bank.name}>
						<h1>{bank.name.toString()}</h1>
						<span>{bank.balance.toString()}</span>
						<button
							className="m-2 text-black group w-60 btn animate-pulse bg-gradient-to-br from-indigo-500 to-fuchsia-500 hover:from-white hover:to-purple-300"
